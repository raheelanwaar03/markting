                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">Give User Reward</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('Admin.Store.Reward', $user->id) }}" method="POST">
                                    @csrf
                                    <div class="mt-4">
                                        <div class="row">
                                            <div class="col-xl-6">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" name="balance" class="form-control"
                                                        id="cleave-prefix" value="{{ $user->balance }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Give Reward</label>
                                            <input type="number" name="balance" class="form-control" placeholder="Enter User Reward">
                                        </div>
                                        <div class="col-xl-6">
                                            <div class="mb-0 mt-2">

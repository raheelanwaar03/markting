                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Approved Withdraws</h5>
                            </div>
                            <div class="card-body">
                                <table id="example"
                                        ...
                                        @foreach ($withdraws as $withdraw)
                                            <tr>
                                                ...
                                                <td><span class="badge badge-primary"
                                                        style="background-color: green;">{{ $withdraw->status }}</span></td>
                                                <td>
                                                    <a href="{{ route('Admin.Make.Withdraw.Rejected', $withdraw->id) }}"
                                                        class="btn btn-danger btn-sm">Rejected</a>
                                                    <a href="{{ route('Admin.Make.Withdraw.Pending', $withdraw->id) }}"

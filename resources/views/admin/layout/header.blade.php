...
<head>
    ...
    <!-- Layout config Js -->
    <script src="{{ asset('admin/asset/js/layout.js') }}"></script>
    <!-- Bootstrap Css -->
    ...
    <!-- custom Css-->
    <link href="{{ asset('admin/asset/css/custom.min.css') }}" rel="stylesheet" type="text/css" />
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="{{ route('Admin.Dashboard') }}" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('admin/asset/images/logo-sm.png') }}" alt=""
                                        height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('admin/asset/images/logo-dark.png') }}" alt=""
                                        height="17">
                                </span>
                            </a>
                            ...
                            <a href="{{ route('Admin.Dashboard') }}" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset('admin/asset/images/logo-light.png') }}" alt=""
                                        height="17">
                                </span>
                            </a>
                        </div>
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user"
                                        src="{{ asset('admin/asset/images/users/avatar-1.jpg') }}"
                                        alt="Header Avatar">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button type="submit" style="border: none;background:white;color:black"><i
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{ route('Admin.Dashboard') }}" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('admin/asset/images/logo-dark.png') }}" alt="" height="17">
                    </span>
                </a>
                <!-- Light Logo-->
                <a href="{{ route('Admin.Dashboard') }}" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('admin/asset/images/logo-light.png') }}" alt="" height="17">
                    </span>
                </a>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarLayouts">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('Admin.Pending.Users') }}" target="_blank"
                                            class="nav-link" data-key="t-horizontal">Pending Users</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('Admin.Approved.Users') }}" target="_blank"
                                            class="nav-link" data-key="t-horizontal">Approved Users</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('Admin.Rejected.Users') }}" target="_blank"
                                            class="nav-link" data-key="t-horizontal">Rejected Users</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarAuth" data-bs-toggle="collapse"
                                ...
                                <i class="ri-stack-line"></i> <span data-key="t-authentication">Settings</span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarPages" data-bs-toggle="collapse"
                                ...
                                <i class="ri-pages-line"></i> <span data-key="t-pages">Deposit</span>
                            </a>
                        ...
                        <li class="menu-title"><i class="ri-more-fill"></i> <span
                                data-key="t-components">Notification</span></li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarUI" data-bs-toggle="collapse" role="button"
                                aria-expanded="false" aria-controls="sidebarUI">
                                <i class="ri-pencil-ruler-2-line"></i> <span data-key="t-base-ui">Notification</span>
                            </a>

...
<style>
    ...
    .card-img {
      width: 100px; /* Set the desired width for your image */
      height: auto;
    ...
    <div class="card-body d-flex align-items-center">
      <!-- Image on the left -->
      <img src="https://s7d2.scene7.com/is/image/Caterpillar/CM20200803-7d970-4b60a?$cc-s$" alt="Card Image" class="card-img">

      <!-- Text beside the image -->
      <div class="ml-3">
        <h5 class="card-title">AD Machine - 4 Days</h5>
        <p class="card-text">4000-6000 <span  style="background-color:cyan;color:white;padding: 5px;border-radius: 20px;">Experimental</span><br> <b>(2.8% Day)</b></p>
      </div>
    ...
    <div class="card-body d-flex align-items-center">
      <!-- Image on the left -->
      <img src="https://image.made-in-china.com/202f0j00zJetTlfEJFrs/All-Sizes-Automation-Bottle-Roller-Mixer-Bulk-Mixing-Mmachine-Apparatus-for-Sale.webp" alt="Card Image" class="card-img">

      <!-- Text beside the image -->
      <div class="ml-3">
        <h5 class="card-title">AD Machine - 9 Days</h5>
        <p class="card-text">4000-6000 <span style="background-color:red;color:white;padding: 5px;border-radius: 20px;">Hot</span><br> <b>(2.8% Day)</b></p>
      </div>
    ...
    <div class="card-body d-flex align-items-center">
      <!-- Image on the left -->
      <img src="https://image.made-in-china.com/202f0j00dtnRSYQPgIuy/Wooden-Door-Design-Making-Wood-CNC-Router-Mmachine.webp" alt="Card Image" class="card-img">

      <!-- Text beside the image -->
      <div class="ml-3">
        <h5 class="card-title">AD Machine - 12 Days</h5>
        <p class="card-text">4000-6000 <span style="background-color:blue;color:white;padding: 5px;border-radius: 20px;">Stable</span><br> <b>(2.8% Day)</b></p>
      </div>
    ...
    <div class="card-body d-flex align-items-center">
      <!-- Image on the left -->
      <img src="https://previews.123rf.com/images/samunella/samunella1801/samunella180100022/94266730-ct-scan-machine-in-radiology-room-on-white-background.jpg') }}" alt="Card Image" class="card-img">

      <!-- Text beside the image -->
      <div class="ml-3">
        <h5 class="card-title">AD Machine - 2 Days</h5>
        <p class="card-text">4000-9000 <span style="background-color:cyan;color:white;padding: 5px;border-radius: 20px;">Experimental</span><br> <b>(2.1% Day)</b></p>
      </div>
    ...
    <div class="card-body d-flex align-items-center">
      <!-- Image on the left -->
      <img src="https://cdn4.vectorstock.com/i/1000x1000/20/33/washing-machine-isolated-on-white-background-vector-17322033.jpg') }}" alt="Card Image" class="card-img">

      <!-- Text beside the image -->
      <div class="ml-3">
        <h5 class="card-title">AD Machine - 2 Days</h5>
        <p class="card-text">4000-6000 <span style="background-color:red;color:white;padding: 5px;border-radius: 20px;">Hot</span><br> <b>(59% Day)</b></p>
      </div>
    ...
    <div class="card-body d-flex align-items-center">
      ...
      <div class="ml-3">
        <h5 class="card-title">AD Machine - 4 Days</h5>
        <p class="card-text">1000-6000 <span style="background-color:green;color:white;padding: 5px;border-radius: 20px;">Stable</span><br> <b>(2.8% Day)</b></p>
      </div>
    ...
    <div class="card-body d-flex align-items-center">
      <!-- Image on the left -->
      <img src="https://electrolux-spares.com.ua/uploads/shop/products/additional/f/fd6e456f7d5711e9911ed62ea498b768_71cd83e461e111ed916dd4c47728c110.jpg') }}" alt="Card Image" class="card-img">

      <!-- Text beside the image -->
      <div class="ml-3">
        <h5 class="card-title">AD Machine - 4 Days</h5>
        <p class="card-text">4000-6000 <span style="background-color:red;color:white;padding: 5px;border-radius: 20px;">Hot</span><br> <b>(3.9% Day)</b></p>
      </div>
    ...
    <div class="bottom-navigation-bar">
        <div class="tf-container">
            <ul class="tf-navigation-bar">
                <li class="active"><a class="fw_6 d-flex justify-content-center align-items-center flex-column" href="home.html"><i class="icon-home2"></i> Home</a> </li>
                ...
                <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="62_rewards.html"><svg width="25" height="24" viewBox="0 0 25 24" fill="none"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="heading">
                    <h2>Privacy</h2>
                    <p class="mt-1 fw_3">
                        A mobile app privacy policy is a legal statement that must be clear, conspicuous, and consented to by all users. It must disclose how a mobile app gathers, stores, and uses the personally identifiable information it collects from its users. A mobile privacy
                        app is developed and presented to users so that mobile app developers stay compliant with state, federal, and international laws. As a result, they fulfill the legal requirement to safeguard user privacy while protecting the company
            ...
            <div class="wrap-transfer mb-5">
                <div class="tf-container">
                    <a href="23_transfer-bank.html" class="action-sheet-transfer">
                        ...
                        <div class="content">
                            <h4 class="fw_6">Deposit</h4>
                            <p>Deposit via Banks</p>
                        </div>
                    </a>
                            ...
                            <ul class="tabs-list-item">
                                <li>
                                    <a href="54_repicient-detail.html" class="recipient-list">
                                        <ul class="inner">
                                            <li class="user">
                                                <img src="{{ asset('assets/images/user/user2.jpg') }}" alt="image">
                                            </li>
                                            <li class="info">
                                                <h4>Andy Cody</h4>
                                                <p>**** **** **** 0674</p>
                                ...
                                <li>
                                    <a href="54_repicient-detail.html" class="recipient-list">
                                        <ul class="inner">
                                            <li class="user">
                                                <img src="{{ asset('assets/images/user/user3.jpg') }}" alt="image">
                                            </li>
                                            <li class="info">
                                                <h4>Alex Tran</h4>
                                                <p>**** **** **** 3216</p>
                                ...
                                <li>
                                    <a href="54_repicient-detail.html" class="recipient-list">
                                        <ul class="inner">
                                            <li class="user">
                                                <img src="{{ asset('assets/images/user/user8.jpg') }}" alt="image">
                                            </li>
                                            <li class="info">
                                                <h4>Themesflat</h4>
                                                <p>**** **** **** 0674</p>
                                ...
                                <li>
                                    <a href="54_repicient-detail.html" class="recipient-list">
                                        <ul class="inner">
                                            <li class="user">
                                                <img src="{{ asset('assets/images/user/user9.jpg') }}" alt="image">
                                            </li>
                                            <li class="info">
                                                <h4>Albert Flores</h4>
                                                <p>**** **** **** 3674</p>
                                ...
                                <li>
                                    <a href="54_repicient-detail.html" class="recipient-list">
                                        <ul class="inner">
                                            <li class="user">
                                                <img src="{{ asset('assets/images/user/user10.jpg') }}" alt="image">
                                            </li>
                                            <li class="info">
                                                <h4>Bruce Banner</h4>
                                                <p>**** **** **** 2432</p>
                                ...
                                <li>
                                    <a href="54_repicient-detail.html" class="recipient-list">
                                        <ul class="inner">
                                            <li class="user">
                                                <img src="{{ asset('assets/images/user/user11.jpg') }}" alt="image">
                                            </li>
                                            <li class="info">
                                                <h4>Benny</h4>
                                                <p>**** **** **** 2341</p>
                                ...
                                <li>
                                    <a href="54_repicient-detail.html" class="recipient-list">
                                        <ul class="inner">
                                            <li class="user">
                                                <img src="{{ asset('assets/images/user/user12.jpg') }}" alt="image">
                                            </li>
                                            <li class="info">
                                                <h4>Christian</h4>
                                                <p>**** **** **** 1255</p>
                                ...
                                <li>
                                    <a href="54_repicient-detail.html" class="recipient-list">
                                        <ul class="inner">
                                            <li class="user">
                                                <img src="{{ asset('assets/images/user/user13.jpg') }}" alt="image">
                                            </li>
                                            <li class="info">
                                ...
                                <li>
                                    <a href="54_repicient-detail.html" class="recipient-list">
                                        <ul class="inner">
                                            <li class="user">
                                                <img src="{{ asset('assets/images/user/user14.jpg') }}" alt="image">
                                            </li>
                                            <li class="info">
                                                <h4>Cody Fisher</h4>
                                                <p>**** **** **** 0674</p>

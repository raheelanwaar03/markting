...
<div class="modal fade" id="modalhome1">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="bottom">
                <a href="#" class="secondary_color btn-hide-modal" data-bs-dismiss="modal"
                    aria-label="Close">Don’t Allow</a>
                <a href="#" class="primary_color btn-hide-modal" data-bs-toggle="modal"
                    data-bs-target="#modalhome2" data-bs-dismiss="modal" aria-label="Close"> Allow</a>
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            <div class="heading">
                ...
                <p class="mt-1 fw_3">
                    ...
                    identifiable information it collects from its users. A mobile privacy
                    app is developed and presented to users so that mobile app developers stay compliant with state,
                    federal, and international laws. As a result, they fulfill the legal requirement to safeguard user
                    privacy while protecting the company
                        ...
                        <div class="noti-box">
                            <div class="noti-list">
                                ...
                                <div class="content-right">
                                    ...
                                    <div class="desc">
                                        <p class="on_surface_color fw_4">Alipay gives you 20% offcoupon for all bills,
                                            applicable for bills paid through Alipay wallet!</p>
                                        <i class="dot"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="noti-list">
                                ...
                                <div class="content-right">
                                    ...
                                    <div class="desc">
                                        <p class="secondary_color fw_4">Alipay gives you 20% offcoupon for all bills,
                                            applicable for bills paid through Alipay wallet!</p>
                                    </div>
                                </div>
                            </div>
...
<div class="tf-panel down">
    ...
    <div class="panel-box panel-down">
        ...
        <div class="wrap-transfer mb-5">
            <div class="tf-container">
                <a href="{{ route('User.Transfer') }}" class="action-sheet-transfer">
        ...
        <div class="content-card mt-3 mb-5">
            <div class="tf-container">
                <div class="tf-card-list bg_surface_color large out-line">
                    <div class="logo">
                        <img src="{{ asset('assets/images/logo-banks/card-visa.png') }}" alt="image">
                    </div>
                    <div class="info">
                ...
                <ul class="box-card">
                    <li class="tf-card-list medium bt-line">
                        <div class="logo">
                            <img src="{{ asset('assets/images/logo-banks/card-visa2.png') }}" alt="image">
                        </div>
                        <div class="info">
            ...
            <div class="tf-container">
                <div class="wrap-fixed">
                    <div class="input-field">
                        ...
                        <input required class="search-field value_input" placeholder="Search" type="text"
                            value="Andy Cody">
